        ...
        <div id="wrapper">
            <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html">ÇALI PİDE</a>
                </div>
                ...
                <div class="header-right">
                    ...
                    <a href="./includes/logout.php" class="btn btn-danger" title="Logout"><i
                            class="fa fa-exclamation-circle fa-2x">
                            <div class="cikis" class="mx-3" style="display : inline-block"> GÜVENLİ ÇIKIŞ
                            </div>
                        </i></a>
